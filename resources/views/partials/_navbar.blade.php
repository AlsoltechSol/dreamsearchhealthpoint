    		...
    		<div class="row no-gutters d-flex align-items-center align-items-stretch">
    			<div class="col-md-4 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="{{route('home')}}">
    				    <img src="{{asset('images/logorbJpeg.png')}}" id="desktopView">
    				    <img src="{{asset('images/logorb.png')}}" id="mobileView">
    				</span></a>
    			</div>
	    		<div class="col-lg-8 d-block">
		    		<div class="row d-flex">
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	...
					    	<div class="text">
					    		<span>Email</span>
						    	<span>contact@dreamsearchhealthpoint.in</span>
						    </div>
					    </div>
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
						    ...
						    <div class="text">
						    	<span>Call</span>
						    	<span>Call Us:7596998656/9831190816</span>
						    </div>
					    </div>
	    ...
	    <div class="container d-flex align-items-center px-4">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	...
	        	<li id="Registration" class="nav-item"><a href="{{route('student-registration.index')}}" class="nav-link">Registration</a></li>
